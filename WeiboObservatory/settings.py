...
SECRET_KEY = 'bx8!l$5(q#665o+urc0dd&amp;o4_g(=vhcxgw8s3yv5s@ei^-(v0x'
...
ROOT_URLCONF = 'WeiboObservatory.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'WeiboObservatory.wsgi.application'
...
AUTH_PROFILE_MODULE = 'Observer.WeiboAccount'
LOGIN_URL  = '/login'
LOGOUT_URL = '/logout'
